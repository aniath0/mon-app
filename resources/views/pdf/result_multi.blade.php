...
.sdw-table { width: 100%; border-collapse: collapse; border: 1px solid #000; margin-bottom: 20px; font-size: 14px; }
.sdw-table td { border: 1px solid #000; padding: 8px; }
.sdw-label { font-weight: bold; width: 15%; }
.sdw-value { width: 35%; }
</style>
</head>
<body>
...
<div class="exam-block">
    ...
    @if($results->first()->exam->type === 'sdw')
        @php $sdw = $results->pluck('resultat', 'param'); @endphp
        <table class="sdw-table">
            <tbody>
                <tr>
                    <td class="sdw-label">AO</td>
                    <td class="sdw-value">( {{ $sdw['AO'] ?? '' }} )</td>
                    <td class="sdw-label">AH</td>
                    <td class="sdw-value">( {{ $sdw['AH'] ?? '' }} )</td>
                </tr>
                <tr>
                    <td class="sdw-label">BO</td>
                    <td class="sdw-value">( {{ $sdw['BO'] ?? '' }} )</td>
                    <td class="sdw-label">BH</td>
                    <td class="sdw-value">( {{ $sdw['BH'] ?? '' }} )</td>
                </tr>
                <tr>
                    <td class="sdw-label">CO</td>
                    <td class="sdw-value">( {{ $sdw['CO'] ?? '' }} )</td>
                    <td class="sdw-label">CH</td>
                    <td class="sdw-value">( {{ $sdw['CH'] ?? '' }} )</td>
                </tr>
                <tr>
                    <td class="sdw-label">TO</td>
                    <td class="sdw-value">( {{ $sdw['TO'] ?? '' }} )</td>
                    <td class="sdw-label">TH</td>
                    <td class="sdw-value">( {{ $sdw['TH'] ?? '' }} )</td>
                </tr>
                <tr>
                    <td class="sdw-label">Conclusion</td>
