    ...
    for(const examId of selected){
        try{
            ...
            if (['spermogramme', 'atb'].includes(data.type)) {
                ...
                `;
            } else if (data.type === 'sdw') {
                tableDiv.innerHTML = `
                    <div class="bg-indigo-100 px-4 py-3 font-semibold text-gray-700 border-b">${data.name} — SDW</div>
                    <div class="p-4">
                        <table class="w-full border border-gray-300 text-sm">
                            <tbody>
                                <tr>
                                    <td class="border px-3 py-2 font-medium w-1/4">AO</td>
                                    <td class="border px-3 py-2 w-1/4">
                                        <input type="text" name="exams[${examId}][sdw][AO]" class="w-full p-1 border rounded" placeholder="( )">
                                    </td>
                                    <td class="border px-3 py-2 font-medium w-1/4">AH</td>
                                    <td class="border px-3 py-2 w-1/4">
                                        <input type="text" name="exams[${examId}][sdw][AH]" class="w-full p-1 border rounded" placeholder="( )">
                                    </td>
                                </tr>
                                <tr>
                                    <td class="border px-3 py-2 font-medium">BO</td>
                                    <td class="border px-3 py-2">
                                        <input type="text" name="exams[${examId}][sdw][BO]" class="w-full p-1 border rounded" placeholder="( )">
                                    </td>
                                    <td class="border px-3 py-2 font-medium">BH</td>
                                    <td class="border px-3 py-2">
                                        <input type="text" name="exams[${examId}][sdw][BH]" class="w-full p-1 border rounded" placeholder="( )">
                                    </td>
                                </tr>
                                <tr>
                                    <td class="border px-3 py-2 font-medium">CO</td>
                                    <td class="border px-3 py-2">
                                        <input type="text" name="exams[${examId}][sdw][CO]" class="w-full p-1 border rounded" placeholder="( )">
                                    </td>
                                    <td class="border px-3 py-2 font-medium">CH</td>
                                    <td class="border px-3 py-2">
                                        <input type="text" name="exams[${examId}][sdw][CH]" class="w-full p-1 border rounded" placeholder="( )">
                                    </td>
                                </tr>
                                <tr>
                                    <td class="border px-3 py-2 font-medium">TO</td>
                                    <td class="border px-3 py-2">
                                        <input type="text" name="exams[${examId}][sdw][TO]" class="w-full p-1 border rounded" placeholder="( )">
                                    </td>
                                    <td class="border px-3 py-2 font-medium">TH</td>
                                    <td class="border px-3 py-2">
                                        <input type="text" name="exams[${examId}][sdw][TH]" class="w-full p-1 border rounded" placeholder="( )">
                                    </td>
                                </tr>
                                <tr>
                                    <td class="border px-3 py-2 font-medium" colspan="1">Conclusion</td>
                                    <td class="border px-3 py-2" colspan="3">
                                        <input type="text" name="exams[${examId}][sdw][conclusion]" class="w-full p-1 border rounded" placeholder="Conclusion">
                                    </td>
                                </tr>
                            </tbody>
                        </table>
