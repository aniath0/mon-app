    ...
    <div class="flex min-h-screen">
        ...
        <div class="w-64 sidebar-bg border-r border-gray-100/50 shadow-sm relative z-10">
            ...
            <nav class="p-4 space-y-1">
                ...
                <a href="/verifier" 
                   class="nav-item flex items-center px-4 py-3 text-sm font-medium rounded-lg transition-all duration-200 {{ request()->is('verifier') ? 'active text-indigo-700 bg-indigo-50/50' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50/50' }}">
                    <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                    </svg>
                    Vérifier
                ...
                <a href="/settings" 
                   class="nav-item flex items-center px-4 py-3 text-sm font-medium rounded-lg transition-all duration-200 {{ request()->is('settings') ? 'active text-indigo-700 bg-indigo-50/50' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50/50' }}">
                    <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
